...
#ifndef STATE_DIAGRAM_COMPONENT_IMPL_INTERNALSTEPTRANSITIONIMPL_H_
#define STATE_DIAGRAM_COMPONENT_IMPL_INTERNALSTEPTRANSITIONIMPL_H_

#include "state_diagram/state_diagram.h"

#include "InternalTransitionImpl.h"
#include "StateImpl.h"
...
, public InternalTransitionImpl
{
public:
  InternalStepTransitionImpl(StateImpl * const host);
...
#endif // STATE_DIAGRAM_COMPONENT_IMPL_INTERNALSTEPTRANSITIONIMPL_H_
