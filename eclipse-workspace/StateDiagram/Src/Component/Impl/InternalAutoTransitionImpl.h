...
#ifndef STATE_DIAGRAM_COMPONENT_IMPL_INTERNALAUTOTRANSITIONIMPL_H_
#define STATE_DIAGRAM_COMPONENT_IMPL_INTERNALAUTOTRANSITIONIMPL_H_
...
{
public:
  InternalAutoTransitionImpl(StateImpl * const host);
...
#endif // STATE_DIAGRAM_COMPONENT_IMPL_INTERNALAUTOTRANSITIONIMPL_H_
