...
#ifndef STATE_DIAGRAM_COMPONENT_IMPL_ENTERTRANSITIONIMPL_H_
#define STATE_DIAGRAM_COMPONENT_IMPL_ENTERTRANSITIONIMPL_H_
...
{
public:
  EnterTransitionImpl(StateImpl * const host);
...
#endif // STATE_DIAGRAM_COMPONENT_IMPL_ENTERTRANSITIONIMPL_H_
