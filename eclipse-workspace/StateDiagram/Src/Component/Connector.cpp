...
#include "Impl/ConnectorStateImpl.h"
...
:
  PImpl<ConnectorStateImpl>{STATE_DIAGRAM_STRING_ARG_COMMA(name) parent.implUpcast()}
, NamePath{m_impl}
, SubState{m_impl}
, SourceState{m_impl}
, TargetState{m_impl}
...
:
  PImpl<ConnectorStateImpl>{STATE_DIAGRAM_STRING_ARG_COMMA(name) parent.m_impl}
, NamePath{m_impl}
, SubState{m_impl}
, SourceState{m_impl}
, TargetState{m_impl}
